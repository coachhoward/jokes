...
class JokesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create joke" do
    assert_difference('Joke.count') do
      post jokes_url, params: { joke: { author: @joke.author, content: @joke.content, title: @joke.title } }, as: :json
    end
  ...
  test "should update joke" do
    patch joke_url(@joke), params: { joke: { author: @joke.author, content: @joke.content, title: @joke.title } }, as: :json
    assert_response 200
  end
